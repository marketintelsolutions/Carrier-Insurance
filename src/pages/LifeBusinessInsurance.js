        ...
        <>
            ...
            <div className="bg-white min-h-screen">
                ...
                <div className="max-w-max mx-auto px-4 py-16">
                    ...
                    {/* Benefits Section */}
                    <div className=" rounded-xl flex flex-wrap lg:flex-nowrap justify-between mb-16">
                        <div className="text-center   max-w-[600px] flex flex-col justify-center mb-8">
                            <h2 className="text-3xl md:text-5xl  font-montserrat font-bold text-primaryBlack mb-8">
                                Why Choose Our Life Insurance?
                            </h2>
                            <p className="text-primaryGrey font-inter text-lg md:text-xl max-w-xl mx-auto">
                    ...
                    <div className="bg-black rounded-xl shadow-lg p-8 text-white">
                        ...
                        <div className="w-fit mx-auto flex flex-wrap md:flex-nowrap justify-center gap-28">
                            <div className=''>
                    ...
                    <div className="text-center bg-gray-50 mt-10  rounded-lg p-8 text-white">
                        <FaShieldAlt className="mx-auto text-5xl text-primaryRed mb-4" />
                        <h2 className="text-2xl font-montserrat text-primaryBlack font-bold mb-4">
                            Need a Suitable Life Insurance?
                        </h2>
                        <p className="font-inter max-w-[700px] text-primaryGrey mx-auto mb-6">
