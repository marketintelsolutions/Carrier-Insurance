    ...
    return (
        <div className='w-[70%] max-w-[1200px] mx-auto mt-[0px]'>
            <div className='flex gap-6'>
                <div className='w-[45%]'>
                    <p className=" h-5 text-[rgb(193,42,18)] text-xl font-semibold font-['Inter'] leading-tight">Blog</p>
                ...
                <div className='w-[52%] flex gap-6'>
                    <div className="w-[288px] h-[279.72px] px-[30px] pt-[49px] pb-[58.34px] bg-[rgb(193,42,18)] rounded-[30px] flex-col justify-center items-start  inline-flex">
