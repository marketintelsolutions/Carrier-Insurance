    ...
    return (
        <section className='px-6 xl:px-0 py-[120px] max-w-[1200px] mx-auto'>
            ...
            <div className='flex flex-wrap lg:flex-nowrap gap-[120px]'>
                ...
                <div className='flex flex-col gap-9 mt-20'>
                    <div className="w-full md:max-w-[468px] h-[297px]  py-[54px] lg:px-[33px] rounded-[30px]" >
                    ...
                    <div className="w-full max-w-[468px] h-[297px] flex items-center justify-center py-[54px] lg:px-[33px] rounded-[30px]" >

                        <p className="md:w-[469px]">
