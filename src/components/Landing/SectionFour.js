    ...
    return (
        <section className=' bg-[#F5F5F5] pt-20 pb-40'>
            <div className='relative bg-black py-20 px-10 rounded-[15px] w-[85%] max-w-max mx-auto flex flex-col items-center'>
                ...
                <h1 className="mt-5  h-12 text-center text-white text-4xl font-extrabold font-['Inter'] leading-[48px]">Insurance Industry and Their Products </h1>

                <div className='w-full flex flex-wrap gap-4 justify-center mt-[55px]'>
                    {
                        services.map((item, index) => (
                            <div key={index} className={`w-[268px] flex flex-col bg-[#F5F5F5] rounded-[15px] pt-[50px] px-[30px] pb-5 ${item.slug === id && 'opacity-60'}`} >
