...
const SectionFive = () => {
    return (
        <section className='bg-[#999999] pt-20 pb-40'>
            <div className='w-full max-w-max mx-auto flex flex-col items-center'>
                <h2 className="w-[125.52px] h-5 text-center text-[#191a1c] text-xl font-semibold font-['Inter'] leading-tight">Our Services</h2>
                ...
                <div className='w-full flex gap-4 justify-center mt-[55px]'>
                    {
                        services.map((item, index) => (
                            <div key={index} className='w-[228px] flex flex-col bg-[#F5F5F5] rounded-[15px] pt-[50px] px-[30px] pb-5' >
                                ...
                                <span className='w-10 h-10 items-center justify-center bg-primaryGreen rounded-full inline-flex text-white'><FaChevronRight size={12} /></span>
                            </div>
                        ))
                    }
                </div>
