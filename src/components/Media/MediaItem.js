    ...
    return (
        <div className='w-full max-w-[780px] p-5 flex gap-[30px] rounded-[10px] shadow-[0px_0px_20px_0px_rgba(0,0,0,0.10)]'>
            ...
            <div>
                ...
                <p className="mt-[14px] mb-[17px] w-[450.60px] h-[46px] text-[#484f5e] text-xl font-semibold font-['Inter'] underline leading-snug">Analysis of Africa's Largest Economy: Business News and Financial Literacy Insights<br />Sub Titles</p> <br/>
